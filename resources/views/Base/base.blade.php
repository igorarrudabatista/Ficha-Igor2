            ...
            <div class="sidebar-wrapper active">
                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        <li class="sidebar-item has-sub ">
                            ...
                            <ul class="submenu ">
                                <li class="sidebar-item  has-sub">
                                    ...
                                    <ul class="submenu ">
                                        <li>
                                            <a href="{{asset('/escola')}}">Consulta Escolas</a>
                                        </li>
                                        <li>
                                            <a href="{{asset('/escola/create')}}">Cadastrar Escola</a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="sidebar-item  has-sub">
                                    ...
                                    <ul class="submenu ">
                                        <li>
                                            <a href="{{asset('/aluno')}}">Consulta Alunos</a>
                                        </li>
                                        <li>
                                            <a href="{{asset('/aluno/create')}}">Cadastrar Alunos</a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="sidebar-item  has-sub">
                        ...
                        <li class='sidebar-title'>Ficha Escolar</li>
                        ...
                        <li class="sidebar-item  has-sub">
                            ...
                            <ul class="submenu ">
                                ...
                                <a href="{{asset('/ficha/create')}}" class='sidebar-link'>
                                ...
                                <a href="{{asset('/ficha/atender')}}" class='sidebar-link'>
                                    <i data-feather="user-check" width="20"></i>
                                    <span> Fichas Tramitadas para mim </span>
                                </a>
                                <hr>
                                ...
                                <li>
                                    <a href="{{asset('/ficha_ministerio')}}">Ver Fichas <b> Ministério Público </b> </a>
                                </li>
                        ...
                        <li class='sidebar-title'>Violência Escolar</li>
