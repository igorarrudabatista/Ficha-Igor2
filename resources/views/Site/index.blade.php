    ...
    <div class="app-main-left cards-area">
      ...
      <div class="card-wrapper main-card">
        <a class="card cardItemjs"  onclick="openModal()">
          ...
          <img src="{{asset('/img/produtos/')}}/{{$Produto->image}}" alt="">
        </div>
          ...
          <div class="card-info">
            ...
            <div class="card-text small">
              Preço:
              <span class="card-price"> R$ {{$Produto->name ?? 'Não encontrado' }}</span>
            </div>
          </div>
          </a>
      </div>
    ...
    <div class="main-modal">
      <div class="modal-left">
        <div class="modal-image-wrapper">
          <img src="{{asset('/img/produtos/')}}/{{$Produto->image}}">
        </div>
        <div class="modal-info-header">
          ...
          Preço:
            <span class="amount">R$ {{$Produto->name ?? 'Não encontrado' }}</span>
          </div>
        </div>
        ...
        <div class="info-bar">
          <div class="info-wrapper">
            ...
            <span> Quantidade: {{$Produto->name ?? 'Não encontrado' }}</span>
          </div>
          <div class="info-wrapper">
            <div class="info-icon">
            ...
            <span>Estoque: {{$Produto->name ?? 'Não encontrado' }}</span>
          </div>
          <div class="info-wrapper">
            <div class="info-icon">
