    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Fichas Conselho</h3>
                <p class="text-subtitle text-muted">
                   <p> Listagem de Fichas Tramitadas para Conselho, <b> {{{ isset(Auth::user()->name) ? Auth::user()->name : Auth::user()->name }}}  </b></p>
            </div>
                ...
                <table class='table table-striped' id="table1">
                    ...
                    @foreach($ficha as $fichas) 
                           ...
                           <td>{{$fichas->updated_at ??  'Sem registros'}} </td>
                            ...
                            <td> <a class="btn btn-warning" href="{{ route('ficha_conselho.edit',$fichas->id) }}">Atender a ficha</a>
